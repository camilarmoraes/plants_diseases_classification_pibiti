"""
mobilenetv2.py — Treino com MobileNet V2 (Transfer Learning).

Utiliza MobileNetV2 pré-treinada (ImageNet) com fine-tuning para classificar
...
Arquitetura: MobileNetV2 (base) → Flatten → Dense(512) → Dense(4)
"""
...
MODEL_OUTPUT = './modelos/MobileNetV2.h5'
TFLITE_OUTPUT = './modelos/TFLITEMobileNetV2.tflite'
TFLITE_QUANT_OUTPUT = './modelos/TFLITEOtimizadoMobileNetV2.tflite'
CSV_RESULTS = './inferenciaMobileNetV2.csv'
ACC_TFLITE_FILE = './modelos/AcuraciaMobileNetV2.txt'
ACC_TFLITE_QUANT_FILE = './modelos/AcuraciaOTIMMobileNetV2.txt'
