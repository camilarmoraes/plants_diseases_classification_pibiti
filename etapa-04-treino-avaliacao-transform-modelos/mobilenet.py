"""
mobilenet.py — Treino com MobileNet V1 (Transfer Learning).

Utiliza MobileNet pré-treinada (ImageNet) com fine-tuning para classificar
...
Arquitetura: MobileNet (base) → Flatten → Dense(512) → Dense(4)
"""
...
MODEL_OUTPUT = './modelos/MobileNet.h5'
TFLITE_OUTPUT = './modelos/TFLITEMobileNet.tflite'
TFLITE_QUANT_OUTPUT = './modelos/TFLITEOtimizadoMobileNet.tflite'
CSV_RESULTS = './inferenciaMobileNet.csv'
ACC_TFLITE_FILE = './modelos/AcuraciaMobileNet.txt'
ACC_TFLITE_QUANT_FILE = './modelos/AcuraciaOTIMMobileNet.txt'
...
all_models_df = pd.concat(
    [tf_pred_df, tflite_pred_df, tflite_quant_pred_df],
