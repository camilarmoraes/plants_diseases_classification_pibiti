"""
nasnetmobile.py — Treino com NASNet Mobile (Transfer Learning).

Utiliza NASNetMobile pré-treinada (ImageNet) com fine-tuning para classificar
...
Arquitetura: NASNetMobile (base) → Flatten → Dense(512) → Dense(4)
"""
...
MODEL_OUTPUT = './modelos/NASNetMobile.h5'
TFLITE_OUTPUT = './modelos/TFLITENASNetMobile.tflite'
TFLITE_QUANT_OUTPUT = './modelos/TFLITEOtimizadoNASNetMobile.tflite'
CSV_RESULTS = './inferenciaNASNetMobile.csv'
ACC_TFLITE_FILE = './modelos/AcuraciaNASNetMobile.txt'
ACC_TFLITE_QUANT_FILE = './modelos/AcuraciaOTIMNASNetMobile.txt'
