"""
mnist.py — Classificação de dígitos com modelo denso (MNIST).

Treina um modelo Sequential simples (Flatten → Dense → Dense) para
classificar dígitos escritos à mão (0-9). Inclui visualização de
predições com código de cor (azul=correto, vermelho=incorreto).
