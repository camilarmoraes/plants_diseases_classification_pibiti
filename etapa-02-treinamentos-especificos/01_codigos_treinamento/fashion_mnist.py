"""
fashion_mnist.py — Classificação de peças de roupa com conversão TFLite.

Treina um modelo Sequential denso (Flatten → Dense → Dense) no Fashion MNIST,
converte para TFLite quantizado (Optimize.DEFAULT) e exporta o binário.
...
file = open( 'modeloConFaSssss.tflite' , 'wb' ) #Criando e digitando um arquivo binário!
